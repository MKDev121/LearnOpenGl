...
char path[200] = "C:\\GitProjects\\LearnOpenGl\\Transformation";
...
int main() {
	...
	Shader shader = Shader("C:\\GitProjects\\LearnOpenGl\\Transformation\\shader.vs", "C:\\GitProjects\\LearnOpenGl\\Transformation\\shader.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		trans1 = glm::scale(trans1, glm::vec3((float)sin(glfwGetTime()), (float)cos(glfwGetTime()), .0f));
